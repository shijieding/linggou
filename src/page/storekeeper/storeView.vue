    ...
    <div>
        ...
        <div class="dsj_footer" v-show="showFoot">
            <div class="footer_flex">
                ...
                <router-link :to="{path:'/storeView/outStore'}">
                    <!--<img src="../../assets/img/out.png" style="width:30px;height:30px;">-->
                    <span class="foot-item f2"></span>
                    <p>出库清单</p>
                </router-link>
                <router-link :to="{path:'/storeView/inStore'}">
                    <!--<img src="../../assets/img/in.png" style="width:30px;height:30px;">-->
                    <span class="foot-item f3"></span>
                    <p>快速入库</p>
                </router-link>
                <router-link :to="{path:'/storeView/storeCenter'}">
                    <!--<img src="../../assets/img/in.png" style="width:30px;height:30px;">-->
...
<style scoped>
    ...
    .router-link-active .f2 {
        background-image: url("../../assets/img/outc.png");
    }
    .f3 {
        background-image: url("../../assets/img/in.png");
    }
    .router-link-active .f3 {
        background-image: url("../../assets/img/inc.png");
    }
    .f4 {
        background-image: url("../../assets/img/storeCenter.png");
    }
    .router-link-active .f4 {
        background-image: url("../../assets/img/storeCenterc.png");
    }
