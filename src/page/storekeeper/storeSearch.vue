<template>
    <div>
        <div>
            <div class="hdg-search">
                <div class="hdg-search-outer">
                    ...
                    <span class="search" @click="getSearch()"><img style="width:17px;height:17px;" src="@/assets/img/newsearch.png" alt=""></span>
                </div>
        ...
        <productDetail v-if="showDetail" @finish="getSearch" @close="close" :pDetail="pDetail"></productDetail>
    </div>
</template>
    ...
    export default {
        ...
        mounted () {
            this.$nextTick(function () {
                let arr = window.localStorage.getItem('storeSearch');
                if(arr){
        ...
        methods:{
            detail (b) {
                ...
                window.localStorage.setItem('storeSearch',json);
            },
            addHistory () {
                if(this.pName){
            ...
            myCloseAlert (bool) {
                ...
                if(bool){
                    this.searchHistoryList = [];
                    window.localStorage.removeItem('storeSearch');
                }
            },
            close () {
